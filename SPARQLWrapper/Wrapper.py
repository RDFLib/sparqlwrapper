...
class SPARQLWrapper:
    ...
    def setHTTPAuth(self, auth: str) -> None:
        ...
        if not isinstance(auth, str):
            ...
            raise ValueError(f"Value should be one of {valid_types}")
        ...
        if self.user and self.passwd:
            if self.http_auth == BASIC:
                ...
                raise NotImplementedError(
                    "Expecting one of: {}, but received: {}".format(
    ...
    def __str__(self) -> str:
        ...
        str_dict_items = "{%s}" % (",\n".join(items))
        return f"<{fullname} object at 0x{id(self):016X}>\n{str_dict_items}"
