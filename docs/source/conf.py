...
sys.path.insert(
    0, os.path.abspath("../../SPARQLWrapper")
)  # from https://stackoverflow.com/questions/10324393/sphinx-build-fail-autodoc-cant-import-find-module
...
man_pages = [(master_doc, "sparqlwrapper", "SPARQLWrapper Documentation", [author], 1)]
